### Мы победили.
Взлом двухэтапки был нужен, потому что техподдержка VimeWorld не помогала её отключать.

В 2024 году техподдержка VimeWorld пересмотрела свои процессы, и теперь аккаунт можно восстановить через них.



В бэкенде ЛК введены новые ограничения, которые окончательно пофиксили этот способ взлома.

Этот репозиторий заархивирован как небольшой кусочек истории проекта VimeWorld.
